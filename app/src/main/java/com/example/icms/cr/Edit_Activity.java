...
public class Edit_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edId.setText(inMainActivity.employeeArrayList.get(position).getId());
        edName.setText(inMainActivity.employeeArrayList.get(position).getName());
        edEmail.setText(inMainActivity.employeeArrayList.get(position).getEmail());
        edContact.setText(inMainActivity.employeeArrayList.get(position).getContact());
        edAddress.setText(inMainActivity.employeeArrayList.get(position).getAddress());
    ...
    public void btn_updateData(View view) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.43.164/crud/update.php",
