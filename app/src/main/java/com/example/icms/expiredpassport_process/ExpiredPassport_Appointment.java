...
public class ExpiredPassport_Appointment extends AppCompatActivity {
    DatePicker expiredpassport_date_picker;
    ...
    Button expiredpassport_appointment_next_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expiredpassport_appointment_next_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ExpiredPassport_Appointment.this, ExpiredPassportApplicationForm2.class);
