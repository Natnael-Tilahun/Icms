...
public class UrgentPassport extends AppCompatActivity {
    Spinner sp_site, sp_city, sp_office, sp_deliverysite;
    Button urgentpassnext_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_urgent_passport);
        ...
        urgentpassnext_btn = findViewById(R.id.urgentpassnext_btn);
        mProgressDialog = new ProgressDialog(UrgentPassport.this);
        ...
        urgentpassnext_btn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void addingDatasToFirestore() {
        ...
        mFirestore.collection("Service").document("PassportService").collection("Urgent Passport").document(userID).set(userdata).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(UrgentPassport.this, "Document Successfully submitted", Toast.LENGTH_LONG).show();
                    //mProgressBar.setVisibility(View.GONE);
                    Intent intent = new Intent(UrgentPassport.this, UrgentPassportApplicationForm2.class);
                    startActivity(intent);
                    mProgressDialog.dismiss();

                } else {
                    Toast.makeText(UrgentPassport.this, "Error:" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
