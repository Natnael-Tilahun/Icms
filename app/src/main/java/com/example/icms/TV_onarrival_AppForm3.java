...
public class TV_onarrival_AppForm3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TV_onarrival_appform3next_btn = findViewById(R.id.TV_onarrival_appform3next_btn);
        TV_onarrival_appform3next_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TV_onarrival_AppForm3.this, TV_onarrivalAppForm4.class);
