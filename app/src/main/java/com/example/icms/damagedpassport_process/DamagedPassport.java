...
public class DamagedPassport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgressDialog = new ProgressDialog(DamagedPassport.this);
    ...
    private void addingDatasToFirestore() {
        ...
        mFirestore.collection("Service").document("PassportService").collection("Damaged Passport").document(userID).set(userdata).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(DamagedPassport.this, "Document Successfully submitted", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(DamagedPassport.this, "Error:" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
