...
public class RI_AppForm3 extends AppCompatActivity {
    ...
    public Uri ri_applicationletteruri, ri_noteverbaleuri;
    TextView ri_applicationletterchooser, ri_noteverbalechooser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ri_applicationletterchooser = findViewById(R.id.ri_applicationletterchooser);
        ri_noteverbalechooser = findViewById(R.id.ri_noteverbalechooser);

        ri_applicationletterchooser.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ri_noteverbalechooser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable final Intent data) {
        ...
        if (requestCode == 1 && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            ri_applicationletterchooser.setText(path);
            ri_applicationletteruri = data.getData();
